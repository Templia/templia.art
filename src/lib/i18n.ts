...
export const UI_STRINGS: Record<Locale, {
  ...
  en: {
    ...
    defaultWelcome: "Your time at Templia begins at a meaningful point in your journey, {name}. This is not a coincidence. In Maya tradition, every day holds its own living energy. The days of your stay are not random \u2014 they are part of a deeper pattern that was already unfolding before you arrived.\n\nWhat follows is a guide to the energies present during your time at Templia \u2014 a map of the influences, symbols, and intentions that accompany you while you are in the land of the Maya.",
    nights: "nights",
